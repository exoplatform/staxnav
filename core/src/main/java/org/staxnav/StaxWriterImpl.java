 ...
 * @version $Revision$
 */
public class StaxWriterImpl<N> implements StaxWriter<N>
{
   ...
   {
      if (elementStack.isEmpty()) throw new StaxNavException("No matching startElement was found for this endElement");
   ...
   {
      return writeContent(ValueType.STRING, content);
   }

   public <V> StaxWriter<N> writeContent(ValueType<V> valueType, V content) throws StaxNavException
   {
      if (valueType == null) throw new IllegalArgumentException("valueType cannot be null.");
      if (content == null) throw new IllegalArgumentException("content cannot be null.");

      Element current = elementStack.peek();
      current.writeContent(valueType.print(content));
   ...
   {
      return writeElement(element, ValueType.STRING, content);
   }

   public <V> StaxWriter<N> writeElement(N element, ValueType<V> valueType, V content) throws StaxNavException
   {
